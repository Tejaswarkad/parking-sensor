...
/* Exported types ------------------------------------------------------------*/
/* USER CODE BEGIN ET */
#define LORAWAN_TXINT_PORT    6
#define LORAWAN_BOARD_RESET_PORT    7
#define LORAWAN_MODBUS_ADDRESS_PORT    9
#define LORAWAN_MODBUS_WRITE_PORT    10
#define UPLINK_TIMER_PORT    11
#define ADR_PORT    12
#define MSG_TYPE_PORT    13
/* USER CODE END ET */
 ...
 */
#define LORAWAN_DEFAULT_TX_POWER                    TX_POWER_10
